      ...
      >
        {items.map((t) => (
          <li
            ...
            className="flex flex-col gap-4 p-6 border border-tinta-media bg-tinta-media/40 rounded-sm"
          >
            <span
              aria-hidden="true"
              data-brand="testimonio-quote-mark"
              className="font-display text-3xl leading-none text-dorado-imperial"
            >
              “
            </span>
            ...
            <footer className="font-body text-sm text-plata-eterea uppercase tracking-[0.2em]">
