 ...
 *
 * Consumers:
 *   - src/infrastructure/auth/config.ts (G_B-1) — passed to DrizzleAdapter(db) via buildAuthConfig.
 ...
 * Same convention as `src/infrastructure/env/index.ts.__resetEnvForTests` and
 * `src/infrastructure/email/resend.ts.__resetResendClient`.
 */
